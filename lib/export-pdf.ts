...
function addFooter(doc: jsPDF) {
  ...
  for (let i = 1; i <= pages; i++) {
    ...
    if (!isPro) {
      ...
      doc.text("StatMate Free", PAGE_W / 2, 150, { align: "center", angle: 45 });
    ...
    doc.text(isPro ? "Generated by StatMate Pro (statmate.org)" : "Generated by StatMate Free — Upgrade to remove watermark (statmate.org/pricing)", MARGIN, 290);
