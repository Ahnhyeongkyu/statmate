      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-4 text-sm">
            <div>
              <span className="text-gray-500">Correlation type</span>
              <p className="font-medium">
                {result.type === "pearson" ? "Pearson r" : "Spearman rho"}
              </p>
            </div>
            <div>
            ...
            <div>
              <span className="text-gray-500"><em>t</em>-statistic</span>
            ...
            <div>
              <span className="text-gray-500"><em>p</em>-value (two-tailed)</span>
              <p className="font-medium">
            ...
            <div className="col-span-2">
              <span className="text-gray-500">95% CI for <em>r</em></span>
              <p className="font-medium">
          ...
          <div className="mt-4 rounded-md bg-gray-50 p-3 text-sm">
            ...
            ({result.r > 0 ? "positive" : "negative"}, <em>r</em> ={" "}
            {result.r.toFixed(2)})
          </div>
        </CardContent>
      </Card>
...
export function CorrelationCalculator() {
  ...
  function handleCalculate() {
    ...
    if (x.length < 3) {
      setError("Variable X needs at least 3 values.");
      return;
    }
    if (y.length < 3) {
      setError("Variable Y needs at least 3 values.");
      return;
    }
    if (x.length !== y.length) {
      setError("Both variables must have the same number of values.");
      return;
    }
      ...
      <div className="space-y-6">
        ...
        >
          <TabsList className="grid w-full grid-cols-2">
            <TabsTrigger value="pearson">Pearson r</TabsTrigger>
            <TabsTrigger value="spearman">Spearman rho</TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="spearman" className="space-y-4">
            <Card>
              <CardHeader>
                <CardTitle className="text-base">Spearman Correlation</CardTitle>
                <CardDescription>
                  Measure the monotonic relationship between two variables using ranks.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div>
