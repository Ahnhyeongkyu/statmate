  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <section className="flex flex-col items-center gap-6 pb-12 pt-8 text-center md:pb-16 md:pt-12">
        ...
        <h1 className="max-w-3xl text-3xl font-bold leading-tight tracking-tight text-gray-900 dark:text-white sm:text-4xl md:text-5xl">
          {t("heroTitle1")}
          <br />
          <span className="text-blue-600">{t("heroTitle2")}</span>
        </h1>
        <p className="max-w-xl text-base text-gray-500 dark:text-gray-400 md:text-lg">
          {t("heroDescription")}
        </p>
        <div className="flex w-full flex-col gap-3 px-4 sm:w-auto sm:flex-row sm:px-0">
          ...
          <a
            href="#calculators"
            className="rounded-full border border-gray-300 px-6 py-3 text-center text-sm font-medium text-gray-700 transition-colors hover:bg-gray-50 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-800"
          >
            {t("ctaViewAll")}
          </a>
        </div>
        ...
        <div className="rounded-xl border bg-white p-6 dark:border-gray-700 dark:bg-gray-800">
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
            ...
            <div className="rounded-lg bg-gray-50 p-4 dark:bg-gray-700">
              <p className="mb-2 text-xs font-semibold uppercase text-blue-600 dark:text-blue-400">{t("demo.step1Label")}</p>
              <div className="font-mono text-xs text-gray-600 dark:text-gray-300">
                <p>Group A: 85, 90, 78, 92, 88</p>
                <p>Group B: 72, 68, 75, 70, 73</p>
              </div>
            </div>
            {/* Step 2: Result */}
            <div className="rounded-lg bg-green-50 p-4 dark:bg-green-900/30">
              <p className="mb-2 text-xs font-semibold uppercase text-green-600 dark:text-green-400">{t("demo.step2Label")}</p>
              <p className="text-xs italic text-gray-700 dark:text-gray-300">
                <em>t</em>(8) = 4.47, <em>p</em> = .002, <em>d</em> = 2.83
              </p>
              <div className="mt-1 flex gap-1">
                <span className="rounded bg-red-100 px-1.5 py-0.5 text-[10px] font-medium text-red-700 dark:bg-red-900/50 dark:text-red-300">p &lt; .01</span>
                <span className="rounded bg-purple-100 px-1.5 py-0.5 text-[10px] font-medium text-purple-700 dark:bg-purple-900/50 dark:text-purple-300">Large Effect</span>
              </div>
            </div>
            {/* Step 3: APA Output */}
            <div className="rounded-lg bg-blue-50 p-4 dark:bg-blue-900/30">
              <p className="mb-2 text-xs font-semibold uppercase text-blue-600 dark:text-blue-400">{t("demo.step3Label")}</p>
              <p className="text-xs italic text-gray-700 dark:text-gray-300">
                {t("demo.apaExample")}
              </p>
            </div>
          ...
          <div className="mt-4 text-center">
            <Link href="/calculators/t-test" className="text-sm font-medium text-blue-600 hover:text-blue-700 dark:text-blue-400">
              {t("demo.tryIt")} →
            </Link>
          </div>
        </div>
      ...
      <section className="w-full pb-8">
        <Link href="/wizard">
          <div className="rounded-xl border-2 border-dashed border-blue-300 bg-blue-50/50 p-6 text-center transition-colors hover:border-blue-400 hover:bg-blue-50 dark:border-blue-700 dark:bg-blue-900/30 dark:hover:border-blue-500 dark:hover:bg-blue-900/50">
      ...
      <section className="w-full pb-12">
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
          {(["calculators", "apa", "free", "privacy"] as const).map((key) => (
            <div key={key} className="rounded-lg border bg-white p-4 text-center dark:border-gray-700 dark:bg-gray-800">
              <p className="text-lg font-bold text-gray-900 dark:text-white">{t(`socialProof.${key}`)}</p>
              <p className="text-xs text-gray-500 dark:text-gray-400">{t(`socialProof.${key}Sub`)}</p>
            </div>
          ))}
        </div>
      </section>
              ...
              <Card className="h-full transition-all duration-200 hover:-translate-y-1 hover:shadow-lg">
                <CardHeader>
                  <div className="flex items-center gap-3">
                    <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-blue-50 text-lg font-semibold italic text-blue-600 dark:bg-blue-900/30 dark:text-blue-400">
                      {calc.icon}
                    </div>
                    <div>
      ...
      <section className="w-full pb-12 md:pb-16">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-3 sm:gap-8">
          <div className="text-center">
            <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-green-50 text-xl dark:bg-green-900/30">
              &check;
            </div>
            <h3 className="mb-2 font-semibold dark:text-white">{t("why.apa.title")}</h3>
            <p className="text-sm text-gray-500 dark:text-gray-400">{t("why.apa.description")}</p>
          </div>
          <div className="text-center">
            <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-blue-50 text-xl dark:bg-blue-900/30">
              &#9889;
            </div>
            <h3 className="mb-2 font-semibold dark:text-white">{t("why.instant.title")}</h3>
            <p className="text-sm text-gray-500 dark:text-gray-400">{t("why.instant.description")}</p>
          </div>
          <div className="text-center">
            <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-purple-50 text-xl dark:bg-purple-900/30">
              &#128196;
            </div>
            <h3 className="mb-2 font-semibold dark:text-white">{t("why.export.title")}</h3>
            <p className="text-sm text-gray-500 dark:text-gray-400">{t("why.export.description")}</p>
          </div>
        </div>
      </section>
      ...
      <section className="w-full pb-12 md:pb-16">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
          {(["step1", "step2", "step3"] as const).map((step, i) => (
            <div key={step} className="rounded-lg border bg-white p-6 text-center dark:border-gray-700 dark:bg-gray-800">
              ...
              <h3 className="mb-2 font-semibold dark:text-white">{t(`how.${step}.title`)}</h3>
              <p className="text-sm text-gray-500 dark:text-gray-400">{t(`how.${step}.description`)}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="w-full pb-12 md:pb-16">
        ...
        <div className="rounded-lg border border-green-100 bg-green-50/50 p-6 dark:border-green-900 dark:bg-green-900/30 md:p-8">
                    ...
                    <ul className="space-y-1 text-sm text-gray-600 dark:text-gray-300">
                      {items.map((item) => (
                        <li key={item} className="flex items-start gap-2">
                          <span className="mt-0.5 shrink-0 text-green-600 dark:text-green-400">&check;</span>
        ...
        <div className="rounded-lg border bg-white p-6 dark:border-gray-700 dark:bg-gray-800">
          ...
          <div className="space-y-4">
            <div className="rounded-md bg-gray-50 p-4 dark:bg-gray-700">
              <p className="text-xs font-semibold text-gray-500 dark:text-gray-400">{t("aiPaperReady")}</p>
            ...
            <div className="rounded-md bg-gray-50 p-4 dark:bg-gray-700">
              <p className="text-xs font-semibold text-gray-500 dark:text-gray-400">{t("aiPlainLanguage")}</p>
          ...
          {(["s1", "s2", "s3"] as const).map((key) => (
            <div key={key} className="rounded-lg border bg-white p-6 dark:border-gray-700 dark:bg-gray-800">
              <p className="mb-2 text-xs font-semibold uppercase text-blue-600 dark:text-blue-400">
                {t(`socialProof.stories.${key}Role`)}
              </p>
              <p className="text-sm leading-relaxed text-gray-600 dark:text-gray-300">
                {t(`socialProof.stories.${key}`)}
              </p>
            </div>
          ))}
        </div>
