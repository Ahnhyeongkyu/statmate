...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: locale === "en" ? "/calculators/t-test" : `/${locale}/calculators/t-test`,
      languages: {
        en: "/calculators/t-test",
        ko: "/ko/calculators/t-test",
        ja: "/ja/calculators/t-test",
        "x-default": "/calculators/t-test",
      },
    },
  };
}
...
export default async function TTestPage({
  ...
  return (
    <div>
      <BreadcrumbSchema locale={locale} calculatorSlug="t-test" calculatorName="T-Test Calculator" />
      <script
