...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: locale === "en" ? "/calculators/correlation" : `/${locale}/calculators/correlation`,
      languages: {
...
export default async function CorrelationPage({
  ...
  return (
    <div>
      <BreadcrumbSchema locale={locale} calculatorSlug="correlation" calculatorName="Correlation Calculator" />
      <script
