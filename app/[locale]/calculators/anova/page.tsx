...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: locale === "en" ? "/calculators/anova" : `/${locale}/calculators/anova`,
      languages: {
        en: "/calculators/anova",
        ko: "/ko/calculators/anova",
        ja: "/ja/calculators/anova",
        "x-default": "/calculators/anova",
      },
    },
  };
}
...
export default async function AnovaPage({
  ...
  return (
    <div>
      <BreadcrumbSchema locale={locale} calculatorSlug="anova" calculatorName="ANOVA Calculator" />
      <script
