...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: locale === "en" ? "/calculators/friedman" : `/${locale}/calculators/friedman`,
      languages: {
...
export default async function FriedmanPage({
  ...
  return (
    <div>
      <BreadcrumbSchema locale={locale} calculatorSlug="friedman" calculatorName="Friedman Test" />
      <script
