...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: locale === "en" ? "/calculators/factor-analysis" : `/${locale}/calculators/factor-analysis`,
      languages: {
        en: "/calculators/factor-analysis",
        ko: "/ko/calculators/factor-analysis",
        ja: "/ja/calculators/factor-analysis",
        "x-default": "/calculators/factor-analysis",
      },
    },
  };
}
...
export default async function FactorAnalysisPage({
  ...
  return (
    <div>
      <BreadcrumbSchema locale={locale} calculatorSlug="factor-analysis" calculatorName="Factor Analysis" />
      <script
