...
Replace every occurrence of `statmate.org` with your new domain.

**Source code files (10 files):**

| File | Line | What to change |
|------|------|----------------|
| `app/[locale]/layout.tsx` | 29 | `const BASE_URL = "https://statmate.org"` |
| `app/sitemap.ts` | 4 | `const BASE_URL = "https://statmate.org"` |
| `app/robots.ts` | 3 | `const BASE_URL = "https://statmate.org"` |
| `app/[locale]/page.tsx` | 17 | `url: "https://statmate.org"` in JSON-LD |
| `components/breadcrumb-schema.tsx` | 1 | `const BASE_URL = "https://statmate.org"` |
| `lib/export-pdf.ts` | 97 | `"Generated by StatMate (statmate.org)"` |
| `app/[locale]/privacy/page.tsx` | 35 | Reference to `statmate.org` |
| `app/[locale]/terms/page.tsx` | 32 | Reference to `statmate.org` |
| `app/[locale]/validation/page.tsx` | 351 | Citation URL |
| `public/robots.txt` | 4 | `Sitemap: https://statmate.org/sitemap.xml` |
...
2. Set **Site URL** to your production domain:
   ...
   ```
   (or `https://statmate.org` if you have not set up a custom domain yet)
...
3. Choose **URL prefix** and enter `https://YOUR_DOMAIN` (or `https://statmate.org`).
...
- [ ] Find-and-replace `statmate.org` with your new domain across 13 files
- [ ] Commit and redeploy
